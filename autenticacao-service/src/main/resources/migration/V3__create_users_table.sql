...
INSERT INTO usuarios (id, nome, email, senha, role, data_criacao, ativo)
VALUES (gen_random_uuid(), 'Administrador', 'admin@financaspessoais.com',
...
INSERT INTO usuarios (id, nome, email, senha, role, data_criacao, ativo)
VALUES (gen_random_uuid(), 'Usuário Teste', 'user@example.com',
